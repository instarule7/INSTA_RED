...
app.commandLine.appendSwitch('–js-flags', '--disable-gpu --disable-d3d11')
...
// app.on('ready', createWindow('first'))
...
autoUpdater.on('update-available', () => {
  contents.send('update_available');
});
autoUpdater.on('update-downloaded', () => {
  contents.send('update_downloaded');
});
